    ...
    <div className="fixed inset-0 bg-[#F9F9F6] z-50 flex flex-col p-6 font-sans select-none overflow-hidden">
      <div className="max-w-md w-full mx-auto flex flex-col h-full">
        ...
        <div className="flex items-center gap-4 mb-4 mt-2">
          ...
          <h2 className="text-4xl font-bold text-[#333333] tracking-tight">
            {today}
          </h2>
        </div>
          ...
          <div className="w-full text-center flex flex-col items-center justify-center mt-4">
            {loading ? (
              ...
              <div className="flex flex-col gap-1 w-full px-4">
                ...
                <p className="text-3xl font-bold text-white/90 tracking-wide mt-2">
                  {vocabulary.meaning}
                </p>
              ...
              <div className="bg-white/20 rounded-2xl p-5 mx-2">
                <p className="text-white font-bold text-xl">
                  ⚠️ Độ chính xác thấp ({selectedConfidence}%)
                </p>
                <p className="text-white/80 text-base mt-1">
                  Hệ thống chưa nhận diện rõ vật thể.
                </p>
                <p className="text-white/60 text-sm mt-2">
                  Vui lòng chụp lại hoặc chọn kết quả khác.
                </p>
              </div>
            ) : (
              <p className="text-white/90 font-bold text-lg px-6">
                Không tìm thấy từ vựng cho "{selectedLabel}"
              </p>
            )}
          </div>
        </div>
